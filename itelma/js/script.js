...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var navMenu = document.querySelector('.menu-1');
  ...
  var counter = document.querySelectorAll('.numbers__number');
  ...
  var videoPlayer = document.querySelectorAll('.js-video');
  videoPlayer.forEach(function (element) {
    var video = element.querySelector('video');
    var videoFilter = element.querySelector('.video__filter');
    video.volume = 0.2;
  ...
  (function () {
    var fileInputs = document.querySelectorAll('.dropzone__input');
    var files = [];
    fileInputs.forEach(function (currentInput) {
      var parentLabel = currentInput.closest('.dropzone__label');
      var tagsUl = currentInput.closest('.dropzone__wrapper').querySelector('.dropzone-output');
      currentInput.addEventListener('dragover', function () {
      ...
      currentInput.addEventListener('change', function () {
        try {
          ...
          (_files = files).push.apply(_files, _toConsumableArray(currentInput.files));
      ...
      if (Array.isArray(tags)) {
        tags.forEach(function (tag) {
          ...
          deleteSpan.addEventListener('click', function (e) {
            e.preventDefault();
            console.log(tag);
            var newFiles = tags.filter(function (t) {
